...
export default function About() {
  return (
    <div className="min-h-screen text-[#e5e5e5] font-sans selection:bg-purple-900 selection:text-white relative">
      ...
      <div className="fixed top-[-10%] left-[-10%] w-[120%] h-[120%] overflow-hidden pointer-events-none z-0 animate-float" style={{ animationDuration: '15s' }}>
        <video 
          autoPlay 
          loop 
          muted 
        ...
        <div className="absolute top-[10%] left-[10%] w-[500px] h-[500px] bg-purple-600/10 rounded-full mix-blend-screen filter blur-[150px] animate-blob"></div>
        <div className="absolute top-[30%] right-[10%] w-[600px] h-[600px] bg-pink-600/10 rounded-full mix-blend-screen filter blur-[150px] animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-[10%] left-[30%] w-[700px] h-[700px] bg-blue-600/10 rounded-full mix-blend-screen filter blur-[150px] animate-blob animation-delay-4000"></div>
      </div>
